...
class InstallationDetailsUI extends StatefulWidget {
  InstallarAllInstallationModel installarAllInstallationList;
   InstallationDetailsUI({super.key,required this.installarAllInstallationList});

  @override
  State<InstallationDetailsUI> createState() => _InstallationDetailsUIState();
}

class _InstallationDetailsUIState extends State<InstallationDetailsUI> {
  ...
  Future Post_GetComplain() async {
    var response = await http.post(Uri.parse(GetComplain), body: {
      'FCmpNum': widget.installarAllInstallationList.cmp.toString(),
    });
