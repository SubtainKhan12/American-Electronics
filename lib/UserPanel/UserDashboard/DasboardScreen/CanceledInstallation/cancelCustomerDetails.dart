...
import '../../../../Models/CancelledInstallations/CancledInstallationModel.dart';
import '../../../../Models/GetComplain/GetComplainModel.dart';
import '../../../../Utilities/Colors/colors.dart';

class CancelCustomerDetailsUI extends StatefulWidget {
  CancledInstallationModel canceledInstallationList;

  CancelCustomerDetailsUI({super.key, required this.canceledInstallationList});

  @override
  State<CancelCustomerDetailsUI> createState() =>
      _CancelCustomerDetailsUIState();
}

class _CancelCustomerDetailsUIState extends State<CancelCustomerDetailsUI> {
  ...
  Future Post_GetComplain() async {
    var response = await http.post(Uri.parse(GetComplain), body: {
      'FCmpNum': widget.canceledInstallationList.cmp.toString(),
    });
