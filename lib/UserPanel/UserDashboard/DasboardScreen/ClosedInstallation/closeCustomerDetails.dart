...
import 'package:american_electronics/Models/ClosedInstallation/ClosedInstallationsModel.dart';
...
class CloseCustomerDetailsUi extends StatefulWidget {
  ClosedInstallationsModel closedInstallationsList;
   CloseCustomerDetailsUi({super.key,required this.closedInstallationsList});

  @override
  State<CloseCustomerDetailsUi> createState() => _CloseCustomerDetailsUiState();
}

class _CloseCustomerDetailsUiState extends State<CloseCustomerDetailsUi> {
  ...
  Future Post_GetComplain() async {
    var response = await http.post(Uri.parse(GetComplain), body: {
      'FCmpNum': widget.closedInstallationsList.cmp.toString(),
    });
