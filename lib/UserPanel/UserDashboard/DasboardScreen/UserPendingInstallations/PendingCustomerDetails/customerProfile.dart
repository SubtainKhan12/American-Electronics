import 'dart:convert';
import 'package:american_electronics/Models/Pending/UserPendingInstallationsModel.dart';
...
class PendingCustomerDetail extends StatefulWidget {
  UserPendingInstallationsModel pendingInstallationStatus;

  PendingCustomerDetail({super.key, required this.pendingInstallationStatus});
...
class _PendingCustomerDetailState extends State<PendingCustomerDetail> {
  ...
  Future Post_GetComplain() async {
    var response = await http.post(Uri.parse(GetComplain), body: {
      'FCmpNum': widget.pendingInstallationStatus.cmp.toString(),
    });
