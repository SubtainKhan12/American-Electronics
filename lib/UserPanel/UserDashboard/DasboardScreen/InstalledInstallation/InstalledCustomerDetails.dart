...
import 'package:american_electronics/Models/InstalledInstalltionModel.dart';
...
class InstalledCustomerDetailsUI extends StatefulWidget {
  InstalledInstalltionModel installedInstalltionList;
   InstalledCustomerDetailsUI({super.key,required this.installedInstalltionList});

  @override
  State<InstalledCustomerDetailsUI> createState() => _InstalledCustomerDetailsUIState();
}

class _InstalledCustomerDetailsUIState extends State<InstalledCustomerDetailsUI> {
  ...
  Future Post_GetComplain() async {
    var response = await http.post(Uri.parse(GetComplain), body: {
      'FCmpNum': widget.installedInstalltionList.cmp.toString(),
    });
