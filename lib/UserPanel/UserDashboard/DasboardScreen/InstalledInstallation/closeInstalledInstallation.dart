...
class CloseInstalledInstallationUI extends StatefulWidget {
  ...
  CloseInstalledInstallationUI(
      {super.key, required this.installedInstalltionList});

  @override
  State<CloseInstalledInstallationUI> createState() =>
      _CloseInstalledInstallationUIState();
}

class _CloseInstalledInstallationUIState
    extends State<CloseInstalledInstallationUI> {
